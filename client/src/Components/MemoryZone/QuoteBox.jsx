...
export const QuoteBox = () => (
  <div className="relative flex items-center bg-gradient-to-tr from-blue-600 via-blue-400 to-blue-500 rounded-2xl shadow-lg px-8 py-6 h-full w-full max-w-xl mx-auto overflow-visible">
    {/* Quote Section */}
